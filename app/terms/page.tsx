...
export default function TermsPage() {
  ...
  const sections = [
    ...
    { icon: AlertTriangle, title: 'Risk Disclosure', content: 'Cryptocurrency investments involve significant risk. Prices can be volatile and you may lose some or all of your investment. We do not guarantee any specific returns. You should only invest what you can afford to lose. We strongly recommend consulting with a qualified financial advisor before making any investment decisions. Blackgold invests is not liable for any financial losses resulting from market conditions.' },
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 leading-relaxed mb-8">
              Please read these Terms and Conditions carefully before using the Blackgold invests investment platform. By using our services, you agree to be bound by the following terms. If you have any questions, please contact our support team before proceeding.
            </p>

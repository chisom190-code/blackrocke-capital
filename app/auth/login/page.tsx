...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Redirect path value:", redirectPath);
      ...
      <div className="hidden lg:flex w-1/2 bg-black relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          <h2 className="text-4xl font-bold text-white mb-4">
            Welcome back to your wealth journey
          </h2>
          <p className="text-gray-400 mb-8">
            Access your portfolio, track investments, and manage your financial
            future.
          </p>
          <div className="space-y-3">
            {[
              "$2.8B+ in managed assets",
              "50,000+ active investors",
              "Up to 30% ROI available",
            ].map((item) => (

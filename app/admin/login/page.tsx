...
export default function AdminLoginPage() {
  ...
  console.log("3. Sign in response", { data, signInError });

  if (signInError) {
    console.log("4. Sign in failed");
    setError(signInError.message);
    setLoading(false);
    return;
  }

  console.log("5. Fetching profile...");
  ...
  console.log("6. Profile response", {
    profile,
    profileError,
  });

  if (profileError) {
    console.log("7. Profile error");
      ...
      <div className="hidden lg:flex w-1/2 bg-black relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-400 mb-8">
            Secure access for authorized administrators only. Manage investors,
            deposits, withdrawals, and platform operations.
          </p>
          <div className="space-y-3">
            {[
              "Manage investor accounts & KYC",
            ...
            <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-red-500 text-xs mt-1">
                  ...
                  {Math.floor(remainingLockout / 60)}:
                  {(remainingLockout % 60).toString().padStart(2, "0")} minutes.
                </p>
              </div>
            </div>
          )}
